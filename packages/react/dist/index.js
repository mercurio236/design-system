...
var AvatarContainer = (0, import_react4.styled)(Avatar.Root, {
  borderRadius: "$full",
...
var AvatarImage = (0, import_react4.styled)(Avatar.Image, {
  width: "100%",
  height: "100%",
  objectFit: "cover",
  borderRadius: "inherit"
});
var AvatarFallback = (0, import_react4.styled)(Avatar.Fallback, {
  width: "100%",
  height: "100%",
  display: "flex",
  alignItems: "center",
...
var Button = (0, import_react5.styled)("button", {
  all: "unset",
  borderRadius: "$sm",
  fontSize: "$sm",
  fontWeight: "$medium",
...
var TextInputContainer = (0, import_react6.styled)("div", {
...
var Prefix = (0, import_react6.styled)("span", {
  fontFamily: "$default",
  fontSize: "$sm",
  color: "$gray400",
  fontWeight: "regular"
});
var Input = (0, import_react6.styled)("input", {
  fontFamily: "$default",
  fontSize: "$sm",
  color: "$white",
  fontWeight: "regular",
...
var TextArea = (0, import_react7.styled)("textarea", {
  backgroundColor: "$gray900",
  padding: "$3 $4",
  borderRadius: "$sm",
  boxSizing: "border-box",
